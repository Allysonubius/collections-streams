package com.example.CollectionsStreams.StreamAPI;
...
public class ExemploStreamAPI {
    public static void main(String[]args){
        ...
        System.out.println ("Menor com numero de letras:"+estudantes.stream().min(Comparator.comparingInt (String::length)));
        //Retorna os elementos que se tem a letra R no nome
        ...
        //Retorna true se algum os elementos possuem a letra a minuscula no nome
        ...
        //  .collect(Collectors.groupingBy(estudante -> estudante.subtring(estudante.indexOf("-") + 1))));
    }
}
